...
from aws_cdk import aws_lambda as _lambda, aws_s3 as s3, Stack, aws_s3_notifications as s3n, aws_ssm as ssm, \
    aws_iam as iam
...
class S3LambdaStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, **kwargs):
        ...
        lambda_function = _lambda.Function(
            ...
            code=_lambda.Code.from_asset("Lambda/awsl.zip"),
        )

         ########################################################################################
         #UNCOMMENT BELOW CODE PART AFTER ALL STACKS WILL DEPLOYED AND DYPLOY S3LambdaStack AGIN#
         ########################################################################################
